...
public class AchievementController {
    ...
    public String createAchievement(ModelMap modelMap) {
        ...
        modelMap.addAttribute("achievement", new Achievement()); // we add a new created achievement to the context so we can edit it
        return view;
    }

    @PostMapping(path = "/save")
    public String saveScene(@Valid Achievement achievement, BindingResult result, ModelMap modelMap) {
        String view = "achievements/listAchievements";
        if (result.hasErrors()) {
            modelMap.addAttribute("achievement", achievement); // achievement with errors as new context to represent it again
    ...
    public String deleteScene(@PathVariable("achievementId") Integer achievementId, ModelMap modelMap) {
        String view = "achievements/listAchievements";
